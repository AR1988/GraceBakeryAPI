...
public class OptionsizeServiceImpl implements OptionsizeService {
    ...
    public OptionsizeDto addOptionsize(OptionsizeDto optionsizeDto) {
        ...
        Size size = sizeRepository.findById(optionsizeDto.getSizeid()).orElseThrow(EntityNotFoundException::new);
    ...
    public OptionsizeDto findOptionsizeById(Long optionsizeId) {
        Optionsize optionsize = optionsizeRepository.findById(optionsizeId).orElseThrow(EntityNotFoundException::new);
        return modelMapper.map(optionsize, OptionsizeDto.class);
    }
    ...
    public OptionsizeDto updateOptionsize(OptionsizeDto optionsizeDto) {
        Optionsize optionsize = optionsizeRepository.findById(optionsizeDto.getId()).orElseThrow(EntityNotFoundException::new);
