...
public class SizeServiceImpl implements SizeService {
    ...
    public SizeDto findSizeById(Long sizeId) {
        Size size = sizeRepository.findById(sizeId).orElseThrow(EntityNotFoundException::new);
        return modelMapper.map(size, SizeDto.class);
    }
    ...
    public SizeDto updateSize(SizeDto sizeDto, Long id) {
        sizeDto.setId(id);
        Size size = sizeRepository.findById(sizeDto.getId()).orElseThrow(EntityNotFoundException::new);
